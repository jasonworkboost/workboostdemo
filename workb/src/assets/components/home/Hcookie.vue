<template>
  <section id="cookielaw" v-if="isOpen">
    <div class="container">
        <div class="col-md-12 pacboost">
          <div class="corridor">
            <ul>
              <li></li>
              <li></li>
...
<style scoped>
#cookielaw .brandcookie{
  transform: translateY(14px);
}

#cookielaw h1, #cookielaw p {
  font-weight: 600;
  color: black;
}
...
#cookielaw ul li:nth-child(1) {
  width: 0;
  height: 0;
  top: 5px;
  border-right: 25px solid transparent;
  border-top: 25px solid #ffbc00;
  border-left: 25px solid #ffbc00;
  border-bottom: 25px solid #ffbc00;
  border-radius: 25px;
  position: relative;
  left: -60px;
  animation: half_up 0.5s infinite, pac_move 5s 1s infinite linear;
  z-index: 1;
}

#cookielaw ul li:nth-child(2) {
  width: 0;
  height: 0;
  border-right: 25px solid transparent;
  border-top: 25px solid #ffbc00;
  ...
  top: 5px;
  margin-top: -50px;
  animation: half_down 0.5s infinite, pac_move 5s 1s infinite linear;
  z-index: 1;
}

#cookielaw ul li:nth-child(3) {
  width: 50px;
  height: 50px;
  background-color: rgb(189, 141, 88);
  border-radius: 100%;
  position: relative;
  left: -60px;
  top: 5px;
  margin-top: -50px;
  animation: cookie_move 5s infinite linear;
  z-index: 1;
}

#cookielaw ul li:nth-child(4) {
  width: 10px;
  height: 10px;
