...
<!-- <svg
            width="36.800000pt"
            height="36.500000pt"
            viewBox="0 0 368.000000 365.000000"
            preserveAspectRatio="xMidYMid meet"
          >
            <g
              ...
              stroke="none"
            >
              <path style="fill: #17C8BC"
                d="M51 3636 c-52 -29 -50 -7 -51 -813 0 -562 3 -759 12 -778 26 -57 2
...
608 0 609 -165 0 -165 0 0 -624z"
              ></path>
              <path style="fill: #17C8BC"
                d="M125 1633 c-69 -36 -107 -99 -107 -173 0 -110 82 -190 195 -190 106
0 187 85 187 196 0 65 -42 134 -99 164 -49 24 -133 26 -176 3z"
              ></path>
              <path style="fill: #17C8BC"
                d="M755 1633 c-70 -37 -105 -94 -105 -174 0 -106 83 -189 189 -189 112
0 191 78 191 190 0 113 -79 190 -192 190 -29 -1 -66 -8 -83 -17z"
              ></path>
              <path style="fill: #17C8BC"
                d="M1368 1621 c-158 -100 -88 -351 99 -351 168 0 258 185 152 312 -61
74 -169 91 -251 39z"
              ></path>
              <path style="fill: #17C8BC"
                d="M141 1010 c-93 -40 -140 -128 -119 -226 14 -65 77 -128 142 -142 125
-26 236 60 236 184 0 107 -73 185 -178 191 -32 1 -68 -2 -81 -7z"
              ></path>
              <path style="fill: #17C8BC"
                d="M752 999 c-132 -67 -136 -270 -7 -337 136 -70 285 18 285 168 0 105
-72 181 -178 187 -44 3 -67 -1 -100 -18z"
              ></path>
              <path style="fill: #17C8BC"
                d="M1395 1006 c-16 -7 -45 -28 -62 -46 -105 -108 -47 -286 104 -320 128
-29 256 106 222 233 -30 116 -157 180 -264 133z"
              ></path>
              <path style="fill: #17C8BC"
                d="M122 369 c-115 -58 -139 -210 -49 -304 72 -74 172 -81 255 -19 102
78 94 239 -16 314 -49 34 -133 38 -190 9z"
              ></path>
              <path style="fill: #17C8BC"
                d="M765 376 c-168 -74 -146 -318 32 -365 75 -20 148 7 200 75 22 30 28
49 31 103 3 59 0 71 -26 112 -50 77 -156 111 -237 75z"
              ></path>
              <path style="fill: #17C8BC"
                d="M1395 375 c-75 -41 -115 -102 -115 -177 1 -165 193 -254 316 -146 47
42 67 83 67 143 1 106 -74 186 -181 192 -39 3 -66 -1 -87 -12z"
              ></path>
            </g>
          </svg>-->
          <!-- <a class="navbar-logo"> WorkBoost</a> -->